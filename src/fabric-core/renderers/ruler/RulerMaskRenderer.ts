// src/fabric-core/renderers/ruler/RulerMaskRenderer.ts
import {
	FABRIC_BACKGROUND_COLOR,
	FABRIC_BACKGROUND_COLOR_DARK,
...
export function renderBottomMask(
	...
	const color = isDarkMode? FABRIC_BACKGROUND_COLOR_DARK : FABRIC_BACKGROUND_COLOR
